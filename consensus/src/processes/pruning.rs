...
use lmt_database::prelude::StoreResultEmptyTuple;
use lmt_hashes::Hash;
    ...
    > PruningPointManager<S, T, U, V, W, Y>
{
    ...
    fn next_pruning_points_v1_inner(
        ...
        /*
            ...
            https://github.com/lmtnet/kips/blob/master/kip-0014.md#pruning-point-adjustment
        */
...
#[cfg(test)]
mod tests {
    use lmt_consensus_core::{config::params::Params, network::NetworkType};
