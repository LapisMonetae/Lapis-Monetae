...
use lmt_core::info;
use lmt_database::prelude::{CachePolicy, ConnBuilder, StoreResultEmptyTuple, StoreResultExtensions};
use lmt_hashes::Hash;
use lmt_pow::{calc_block_level, calc_block_level_check_pow};
...
impl PruningProofManager {
    ...
    fn init_validate_pruning_point_proof_stores_and_processes(
        ...
        let (db_lifetime, db) = lmt_database::create_temp_db!(ConnBuilder::default().with_files_limit(10));
