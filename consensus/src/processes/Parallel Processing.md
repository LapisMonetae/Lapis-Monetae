...
## Sequential processing flow (in go-lmtd)

Below we detail the current state of affairs in *go-lmtd* and discuss future parallelism opportunities. Processing dependencies between various stages are detailed in square brackets [***deps; type***].
...
The current code design (*go-lmtd*) already logically supports this since the various processing stages were already decoupled for supporting efficient IBD.
