//!
//! # Standardized JSON serialization and deserialization of Lapis Monetae transactions.
//!
//! This module provides standardized JSON serialization and deserialization of
//! Lapis Monetae transactions. There are two sub-modules: `numeric` and `string`.
//!
...
//! For more advanced use cases, please refer to `PSKT` in the [`lmt_wallet_pskt`](https://docs.rs/lmt_wallet_pskt)
//! crate.
//!
