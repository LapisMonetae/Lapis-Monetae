...
use lmt_consensus::consensus::Consensus;
use lmt_consensus::model::stores::virtual_state::VirtualStateStoreReader;
use lmt_consensus::params::Params;
use lmt_consensus_core::api::ConsensusApi;
use lmt_consensus_core::block::{Block, TemplateBuildMode, TemplateTransactionSelector};
use lmt_consensus_core::coinbase::MinerData;
use lmt_consensus_core::mass::MassCalculator;
use lmt_consensus_core::sign::sign;
...
use lmt_consensus_core::utxo::utxo_view::UtxoView;
use lmt_core::trace;
use lmt_utils::sim::{Environment, Process, Resumption, Suspension};
...
impl TemplateTransactionSelector for OnetimeTxSelector {
    ...
    fn reject_selection(&mut self, _tx_id: lmt_consensus_core::tx::TransactionId) {
        unimplemented!()
    }
