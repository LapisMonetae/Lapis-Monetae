...
use lmt_consensus::config::Config;
...
use lmt_database::{create_permanent_db, create_temp_db};
use lmt_utils::fd_budget;
use lmt_utils::sim::Simulation;

type ConsensusWrapper = (Arc<Consensus>, Vec<JoinHandle<()>>, DbLifetime);

pub struct LmtNetworkSimulator {
