...
macro_rules! trace {
    ($($t:tt)*) => {
        if lmt_core::log::workflow_log::log_level_enabled(log::Level::Trace) {
            lmt_core::log::workflow_log::impls::trace_impl(None, &format_args!($($t)*));
        }
    };
}
...
macro_rules! debug {
    ($($t:tt)*) => (
        if lmt_core::log::workflow_log::log_level_enabled(log::Level::Debug) {
            lmt_core::log::workflow_log::impls::debug_impl(None, &format_args!($($t)*));
        }
    )
}
...
macro_rules! info {
    ($($t:tt)*) => (
        if lmt_core::log::workflow_log::log_level_enabled(log::Level::Info) {
            lmt_core::log::workflow_log::impls::info_impl(None, &format_args!($($t)*));
        }
    )
}
...
macro_rules! warn {
    ($($t:tt)*) => (
        if lmt_core::log::workflow_log::log_level_enabled(log::Level::Warn) {
            lmt_core::log::workflow_log::impls::warn_impl(None, &format_args!($($t)*));
        }
    )
}
...
macro_rules! error {
    ($($t:tt)*) => (
        if lmt_core::log::workflow_log::log_level_enabled(log::Level::Error) {
            lmt_core::log::workflow_log::impls::error_impl(None, &format_args!($($t)*));
        }
    )
}
