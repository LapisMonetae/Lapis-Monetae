use lmt_core::debug;
use lmt_p2p_lib::echo::EchoFlowInitializer;
...
async fn main() {
    // [-] - init logger
    lmt_core::log::init_logger(None, "debug");
    ...
    let adaptor = lmt_p2p_lib::Adaptor::bidirectional(ip_port, lmt_p2p_lib::Hub::new(), initializer, Default::default()).unwrap();
