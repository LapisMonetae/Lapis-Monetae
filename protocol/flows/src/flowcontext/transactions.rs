...
use lmt_p2p_lib::{
    make_message,
    pb::{lmtd_message::Payload, InvTransactionsMessage, LmtdMessage},
    Hub,
};
...
impl TransactionsSpread {
    ...
    /// capacity.
    ///
    /// _GO-LMTD: EnqueueTransactionIDsForPropagation_
    ...
    async fn broadcast(&self, msg: LmtdMessage, should_throttle: bool) {
        if should_throttle {
