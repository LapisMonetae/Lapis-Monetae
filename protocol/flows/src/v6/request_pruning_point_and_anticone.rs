...
//! since the syncee no longer uses them in the lapis-monetae design where the full sub-DAG is sent
//!
...
use lmt_p2p_lib::{
    ...
    pb::{
        self, lmtd_message::Payload, BlockWithTrustedDataV4Message, DoneBlocksWithTrustedDataMessage, PruningPointsMessage,
        TrustedDataMessage,
    },
