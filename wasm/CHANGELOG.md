Latest online documentation available at: https://lmt.aspectron.org/docs/
...
- Merge with Rusty Lapis Monetae master (0.13.6)
...
- Rename `lmt-beacon` app to `lmt-resolver`
...
- Introduced `Beacon` class that provides connectivity to the community-operated public node infrastructure (backed by `lmt-beacon` load balancer & node status monitor)
...
- Changed documentation structure to use `typedoc` available as a part of redistributables or online at https://lmt.aspectron.org/docs/
