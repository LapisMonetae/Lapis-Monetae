use lmt_consensus_core::network::NetworkId;
use lmt_core::{core::Core, signals::Shutdown, task::runtime::AsyncRuntime};
...
use lmt_rpc_core::notify::mode::NotificationMode;
use lmt_rpc_service::service::RpcCoreService;
use lmt_utils::triggers::Listener;
use lmtd_lib::{args::Args, daemon::create_core_with_runtime};
use parking_lot::RwLock;
use std::{ops::Deref, sync::Arc, time::Duration};
use tempfile::TempDir;

use lmt_grpc_client::ClientPool;
...
impl Daemon {
    ...
    pub fn with_manager(client_manager: Arc<ClientManager>, fd_total_budget: i32) -> Daemon {
        let appdir_tempdir = get_lmt_tempdir();
