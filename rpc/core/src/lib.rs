//! # RPC Core
//!
//! This crate provides foundational primitives used in Rusty Lapis Monetae node RPC subsystem.
...
//!
//! This crate acts as a foundation for [`lmt_grpc_client`](https://docs.rs/lmt_grpc_client) and
//! [`lmt_wrpc_client`](https://docs.rs/lmt_wrpc_client) crates, which provide gRPC and WebSocket
//! RPC client implementations. This crate is also used by WASM bindings to provide [WASM RpcClient
//! implementation](https://docs.rs/lmt-wrpc-client/latest/lmt_wrpc_client/wasm/struct.RpcClient.html)
//! (based on wRPC).
//!
