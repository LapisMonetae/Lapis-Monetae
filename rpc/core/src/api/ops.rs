...
pub enum RpcApiOps {
    ...
    GetSyncStatus = 115,
    /// Returns the network this LMTD is connected to (Mainnet, Testnet)
    ...
    /// Returns a list of all the addresses (IP, port) this LMTD knows and a list of all addresses that are currently banned by this LMTD
    ...
    /// Returns a list of the peers currently connected to this LMTD, along with some statistics on them
    GetConnectedPeerInfo = 123,
    /// Instructs LMTD to connect to a given IP address.
    AddPeer = 124,
