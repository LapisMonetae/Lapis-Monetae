//!
//! # WASM bindings for the [Lapis Monetae p2p Node RPC client](LmtRpcClient).
//!
//! This module provides a WASM interface for the Lapis Monetae p2p Node RPC client
//! - [`RpcClient`].
//!
...
use lmt_addresses::{Address, AddressOrStringArrayT};
use lmt_consensus_client::UtxoEntryReference;
use lmt_consensus_core::network::{NetworkType, NetworkTypeT};
use lmt_notify::connection::ChannelType;
use lmt_notify::events::EventType;
use lmt_notify::listener;
use lmt_notify::notification::Notification as NotificationT;
use lmt_rpc_core::api::ctl;
pub use lmt_rpc_core::wasm::message::*;
pub use lmt_rpc_macros::{
...
pub(crate) struct Inner {
    ...
    notification_channel: Channel<lmt_rpc_core::Notification>,
}
...
///
///
/// Lapis Monetae RPC client uses ([wRPC](https://github.com/workflow-rs/workflow-rs/tree/master/rpc))
/// interface to connect directly with Lapis Monetae Node. wRPC supports
/// two types of encodings: `borsh` (binary, default) and `json`.
///
/// There are two ways to connect: Directly to any Lapis Monetae Node or to a
...
/// ```
///
/// **Connecting to a Lapis Monetae Node directly**
///
/// ```javascript
/// let rpc = new RpcClient({
...
/// to re-register event listeners, but your have to re-subscribe for Lapis Monetae node
/// notifications:
///
/// ```typescript
/// rpc.addEventListener("connect", async (event) => {
...
impl RpcClient {
    pub fn new(config: Option<RpcConfig>) -> Result<RpcClient> {
        ...
        let client = Arc::new(
            LmtRpcClient::new(encoding, url.as_deref(), resolver.clone().map(Into::into), network_id, None)
...
impl RpcClient {
    ...
    /// Connect to the Lapis Monetae RPC server. This function starts a background
    ...
    /// Disconnect from the Lapis Monetae RPC server.
    ...
    /// however, you have to re-subscribe for Lapis Monetae node notifications. As such, it is recommended
...
impl RpcClient {
    pub fn new_with_rpc_client(client: Arc<LmtRpcClient>) -> RpcClient {
    ...
    pub fn client(&self) -> &Arc<LmtRpcClient> {
        &self.inner.client
    }
                ...
                select_biased! {
                    ...
                    msg = notification_receiver.recv().fuse() => {
                        if let Ok(notification) = &msg {
                            match &notification {
                                lmt_rpc_core::Notification::UtxosChanged(utxos_changed_notification) => {
...
impl RpcClient {
    ...
    pub fn parse_url(url: &str, encoding: Encoding, network: NetworkId) -> Result<String> {
        let url_ = LmtRpcClient::parse_url(url.to_string(), encoding, network.into())?;
        Ok(url_)
    }
}
...
impl RpcClient {
    ...
    /// Difficulty Adjustment Algorithm (DAA) score changes in the Lapis Monetae BlockDAG.
    ...
    /// Lapis Monetae BlockDAG. The event notification will be scoped to the
    ...
    /// chain changes in the Lapis Monetae BlockDAG.
...
build_wrpc_wasm_bindgen_subscriptions!([
    ...
    /// block is added to the Lapis Monetae BlockDAG.
    BlockAdded,
    ...
    /// conflict occurs in the Lapis Monetae BlockDAG.
    FinalityConflict,
    ...
    /// conflict in the Lapis Monetae BlockDAG is resolved.
    ...
    /// score of the sink block changes in the Lapis Monetae BlockDAG.
    ...
    /// UTXO set override for the pruning point changes in the Lapis Monetae BlockDAG.
    ...
    /// template is generated for mining in the Lapis Monetae BlockDAG.
    NewBlockTemplate,
]);
...
build_wrpc_wasm_bindgen_interface!(
    [
        ...
        /// Retrieves the current number of blocks in the Lapis Monetae BlockDAG.
        ...
        /// structure of the Lapis Monetae BlockDAG.
        ...
        GetBlockDagInfo,
        /// Returns the total current coin supply of Lapis Monetae network.
        /// Returned information: Total coin supply.
        GetCoinSupply,
        /// Retrieves information about the peers connected to the Lapis Monetae node.
        /// Returned information: Peer ID, IP address and port, connection
        /// status, protocol version.
        GetConnectedPeerInfo,
        /// Retrieves general information about the Lapis Monetae node.
        /// Returned information: Version of the Lapis Monetae node, protocol
        /// version, network identifier.
        /// This call is primarily used by gRPC clients.
        /// For wRPC clients, use {@link RpcClient.getServerInfo}.
        GetInfo,
        /// Provides a list of addresses of known peers in the Lapis Monetae
        ...
        /// performance and status of the Lapis Monetae node.
        ...
        /// the highest cumulative difficulty in the Lapis Monetae BlockDAG.
        ...
        GetSinkBlueScore,
        /// Tests the connection and responsiveness of a Lapis Monetae node.
        /// Returned information: None.
        Ping,
        /// Gracefully shuts down the Lapis Monetae node.
        /// Returned information: None.
        Shutdown,
        /// Retrieves information about the Lapis Monetae server.
        /// Returned information: Version of the Lapis Monetae server, protocol
        /// version, network identifier.
        GetServerInfo,
        /// Obtains basic information about the synchronization status of the Lapis Monetae node.
    ...
    [
        ...
        /// Adds a peer to the Lapis Monetae node's list of known peers.
        /// Returned information: None.
        AddPeer,
        /// Bans a peer from connecting to the Lapis Monetae node for a specified duration.
        /// Returned information: None.
        Ban,
        ...
        /// Retrieves the balance of a specific address in the Lapis Monetae BlockDAG.
        /// Returned information: Balance of the address.
        GetBalanceByAddress,
        /// Retrieves balances for multiple addresses in the Lapis Monetae BlockDAG.
        /// Returned information: Balances of the addresses.
        GetBalancesByAddresses,
        /// Retrieves a specific block from the Lapis Monetae BlockDAG.
        /// Returned information: Block information.
        GetBlock,
        /// Retrieves multiple blocks from the Lapis Monetae BlockDAG.
        ...
        /// Retrieves block headers from the Lapis Monetae BlockDAG.
        /// Returned information: List of block headers.
        GetHeaders,
        /// Retrieves mempool entries from the Lapis Monetae node's mempool.
        ...
        GetMempoolEntry,
        /// Retrieves information about a subnetwork in the Lapis Monetae BlockDAG.
        ...
        /// Resolves a finality conflict in the Lapis Monetae BlockDAG.
        /// Returned information: None.
        ResolveFinalityConflict,
        /// Submits a block to the Lapis Monetae network.
        /// Returned information: None.
        SubmitBlock,
        /// Submits a transaction to the Lapis Monetae network.
        /// Returned information: Submitted Transaction Id.
        SubmitTransaction,
        /// Submits an RBF transaction to the Lapis Monetae network.
        ...
        /// to the Lapis Monetae node again.
        /// Returned information: None.
        Unban,
