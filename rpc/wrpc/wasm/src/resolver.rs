//! [`Resolver`](NativeResolver) bindings for obtaining public Lapis Monetae wRPC URL endpoints.
...
use crate::imports::*;
use js_sys::Array;
pub use lmt_rpc_macros::declare_typescript_wasm_interface as declare;
use lmt_wrpc_client::node::NodeDescriptor;
use lmt_wrpc_client::Resolver as NativeResolver;
use serde::ser;
...
///
/// Resolver is a client for obtaining public Lapis Monetae wRPC URL.
///
/// Resolver queries a list of public Lapis Monetae Resolver URLs using HTTP to fetch
...
#[wasm_bindgen]
impl Resolver {
    /// List of public Lapis Monetae Resolver URLs.
    #[wasm_bindgen(getter)]
    ...
    /// Fetches a public Lapis Monetae wRPC endpoint for the given encoding and network identifier.
    ...
    /// Fetches a public Lapis Monetae wRPC endpoint URL for the given encoding and network identifier.
    ...
    /// Connect to a public Lapis Monetae wRPC endpoint for the given encoding and network identifier
