use crate::protowire::{lmtd_request::Payload as RequestPayload, lmtd_response::Payload as ResponsePayload, *};
...
pub enum LmtdPayloadOps {
    ...
    // The conversion from a notification ResponsePayload into LmtdPayloadOps fails.
}
}
