...
use lmt_core::lmtd_env::version;
use lmt_notify::address::tracker::Tracker;
use lmt_utils::networking::ContextualNetAddress;
use lmt_wrpc_server::address::WrpcNetAddress;
...
impl Args {
    ...
    #[cfg(feature = "devnet-prealloc")]
    pub fn generate_prealloc_utxos(&self, num_prealloc_utxos: u64) -> lmt_consensus_core::utxo::utxo_collection::UtxoCollection {
...
pub fn cli() -> Command {
    ...
    let cmd = Command::new("lmtd")
        .about(format!("{} (lapis-monetae) v{}", env!("CARGO_PKG_DESCRIPTION"), version()))
...
/*
  ...
  -a, --addpeer=                            Add a peer to connect with at startup
      ...
      --rpccert=                            File containing the certificate file (default:
                                            /Users/aspect/Library/Application Support/lapis-monetae/rpc.cert)
      --rpckey=                             File containing the certificate key (default:
                                            /Users/aspect/Library/Application Support/lapis-monetae/rpc.key)
  ...
  -d, --loglevel=                           Logging level for all subsystems {trace, debug, info, warn, error,
      ...
      --minrelaytxfee=                      The minimum transaction fee in LMT/kB to be considered a non-zero fee.
                                            (default: 1e-05)
