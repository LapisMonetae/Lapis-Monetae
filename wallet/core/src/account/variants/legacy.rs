//!
//! Legacy (KDX, lmtnet.io Web Wallet) account implementation
//!

use crate::account::{AsLegacyAccount, Inner};
use crate::derivation::{AddressDerivationManager, AddressDerivationManagerTrait};
use crate::imports::*;
use lmt_bip32::{ExtendedPrivateKey, Prefix, SecretKey};

const CACHE_ADDRESS_OFFSET: u32 = 2048;

pub const LEGACY_ACCOUNT_KIND: &str = "lmt-legacy-standard";
...
impl Factory for Ctor {
    ...
    fn description(&self) -> String {
        "LMT Legacy Account (KDX, lmtnet.io Web Wallet)".to_string()
    }
