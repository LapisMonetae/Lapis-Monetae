...
use lmt_addresses::{Address, Prefix};
// use lmt_bip32::Prefix;
use lmt_consensus_core::network::{NetworkId, NetworkType};
use lmt_consensus_core::tx::{ScriptPublicKey, TransactionOutpoint, UtxoEntry};

use hex;
use lmt_consensus_core::constants::UNACCEPTED_DAA_SCORE;
use lmt_txscript::{extract_script_pub_key_address, pay_to_address_script, pay_to_script_hash_script};
...
pub fn script_sig_to_address(script_sig: &[u8], prefix: lmt_addresses::Prefix) -> Result<Address, Error> {
...
mod tests {
    ...
    use crate::role::*;
    use lmt_consensus_core::tx::{TransactionId, TransactionOutpoint, UtxoEntry};
    use lmt_txscript::{multisig_redeem_script, pay_to_script_hash_script};
